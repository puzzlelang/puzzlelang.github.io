...
<h3 class="header" style="padding:none !important">An <span class="highlight-primary">abstract</span>, extendable programming language that runs on <span class="highlight-primary">Browsers</span>, <span class="highlight-primary">Node</span>, and other JavaScript platforms.</h3>
